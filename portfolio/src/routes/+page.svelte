...
>
  <div class=" flex flex-col z-0">
    ...
    <p class="text-white text-2xl ml-16 mt-8">
      I am studying IT at <a
    ...
    <h3 class="text-3xl ml-16 text-white font-bold mt-4">My skillset:</h3>
    <ul class="text-white list-none ml-20 text-xl">
      <li class="flex flex-row items-center">
        ∘ Web Development with React <svg
      ...
      <li class="flex flex-row items-center">
        ∘ Desktop Application Development with <svg
          width="25"
          height="25"
          class="m-1"
          viewBox="0 0 256 288"
      ...
      <li class="flex flex-row items-center">
        ∘ API Development with Java Spring <svg
          xmlns="http://www.w3.org/2000/svg"
      ...
      <li class="flex flex-row items-center">+ Knowledge in Business Administration</li>
    </ul> 
    ...
    <div data-dial-init class="absolute right-5 bottom-5 m-10 z-20">
      ...
      <button
        ...
        aria-expanded="false"
        class="wave text-white text-xl bg-indigo-500 rounded-3xl flex flex-row px-6 py-3 transition-all focus:bg-white border border-indigo-500 focus:text-indigo-500"
      >
        <p>👋</p>
        Contact Me
...
<!-- Bubble Animations: shamelessly stolen from https://codepen.io/Mark_Bowley/pen/PozwyP  -->
